...
# idx = int(sys.argv[1])
for h, attr in enumerate(lab_attributes):
	...
	print("\rattributes {}/{}, {}, best K: {}, Number of training data: {}, Number of predicting data: {}.".format(h+1, len(lab_attributes), attr, k_neighbors, len(X), len(test)), end="")
	sys.stdout.flush()
...
sepsis_data.to_csv("./data/fuzzyKnn015.csv")
